...
int main() 
{
	...
	*/
	...
	Ipv4AddressHelper routerIP = Ipv4AddressHelper("172.15.0.0", "255.255.255.0");	//(network, mask)
	...
	********************************************************************/
	...
	Ptr<OutputStreamWrapper> h1cw = asciiTraceHelper.CreateFileStream("PartA/DataFiles/data_hybla_a.cw");
	Ptr<OutputStreamWrapper> h1cl = asciiTraceHelper.CreateFileStream("PartA/DataFiles/hybla_a.cl");
	Ptr<OutputStreamWrapper> h1tp = asciiTraceHelper.CreateFileStream("PartA/DataFiles/data_hybla_a.tp");
	Ptr<OutputStreamWrapper> h1gp = asciiTraceHelper.CreateFileStream("PartA/DataFiles/data_hybla_a.gp");
	...
	Ptr<OutputStreamWrapper> h2cw = asciiTraceHelper.CreateFileStream("PartA/DataFiles/data_westwoodplus_a.cw");
	Ptr<OutputStreamWrapper> h2cl = asciiTraceHelper.CreateFileStream("PartA/DataFiles/westwoodplus_a.cl");
	Ptr<OutputStreamWrapper> h2tp = asciiTraceHelper.CreateFileStream("PartA/DataFiles/data_westwoodplus_a.tp");
	Ptr<OutputStreamWrapper> h2gp = asciiTraceHelper.CreateFileStream("PartA/DataFiles/data_westwoodplus_a.gp");
	...
	Ptr<OutputStreamWrapper> h3cw = asciiTraceHelper.CreateFileStream("PartA/DataFiles/data_yeah_a.cw");
	Ptr<OutputStreamWrapper> h3cl = asciiTraceHelper.CreateFileStream("PartA/DataFiles/yeah_a.cl");
	Ptr<OutputStreamWrapper> h3tp = asciiTraceHelper.CreateFileStream("PartA/DataFiles/data_yeah_a.tp");
	Ptr<OutputStreamWrapper> h3gp = asciiTraceHelper.CreateFileStream("PartA/DataFiles/data_yeah_a.gp");
